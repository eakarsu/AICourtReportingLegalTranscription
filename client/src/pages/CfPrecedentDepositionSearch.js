...
/**
 * Gap/CFS Feature Page: Precedent deposition search
 * Slug: precedent-deposition-search
 * Backend: /api/cf-precedent-deposition-search
 */
export default function PrecedentDepositionSearchPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-precedent-deposition-search', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Precedent deposition search</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Semantic search across your transcript library for similar prior testimony.</p>
