...
/**
 * Gap/CFS Feature Page: `cases` lacks `/analyze-case-timeline` or `/predict-deposition-needs`.
 * Slug: cases-lacks-analyze-case-timeline-or-predict-deposition-need
 * Backend: /api/gap-cases-lacks-analyze-case-timeline-or-predict-deposition-need
 */
export default function CasesLacksAnalyzeCaseTimelineOrPredictDepositionNeedPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-cases-lacks-analyze-case-timeline-or-predict-deposition-need', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`cases` lacks `/analyze-case-timeline` or `/predict-deposition-needs`.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`cases` lacks `/analyze-case-timeline` or `/predict-deposition-needs`.</p>
