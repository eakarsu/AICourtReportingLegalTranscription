...
/**
 * Gap/CFS Feature Page: Automated exhibit extraction
 * Slug: automated-exhibit-extraction
 * Backend: /api/cf-automated-exhibit-extraction
 */
export default function AutomatedExhibitExtractionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-automated-exhibit-extraction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Automated exhibit extraction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Parse PDFs/images in deposition; extract and tag exhibits with OCR and semantic extraction.</p>
