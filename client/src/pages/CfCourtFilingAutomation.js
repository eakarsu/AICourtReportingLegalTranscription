...
/**
 * Gap/CFS Feature Page: Court filing automation
 * Slug: court-filing-automation
 * Backend: /api/cf-court-filing-automation
 */
export default function CourtFilingAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-court-filing-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Court filing automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Generate motion/brief excerpts from deposition transcripts; auto-cite to transcript timestamps.</p>
