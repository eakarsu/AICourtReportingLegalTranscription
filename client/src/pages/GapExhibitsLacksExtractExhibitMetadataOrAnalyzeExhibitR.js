...
/**
 * Gap/CFS Feature Page: `exhibits` lacks `/extract-exhibit-metadata` or `/analyze-exhibit-relevance`.
 * Slug: exhibits-lacks-extract-exhibit-metadata-or-analyze-exhibit-r
 * Backend: /api/gap-exhibits-lacks-extract-exhibit-metadata-or-analyze-exhibit-r
 */
export default function ExhibitsLacksExtractExhibitMetadataOrAnalyzeExhibitRPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-exhibits-lacks-extract-exhibit-metadata-or-analyze-exhibit-r', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`exhibits` lacks `/extract-exhibit-metadata` or `/analyze-exhibit-relevance`.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`exhibits` lacks `/extract-exhibit-metadata` or `/analyze-exhibit-relevance`.</p>
