...
/**
 * Gap/CFS Feature Page: Predictive case complexity scoring
 * Slug: predictive-case-complexity-scoring
 * Backend: /api/cf-predictive-case-complexity-scoring
 */
export default function PredictiveCaseComplexityScoringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-case-complexity-scoring', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive case complexity scoring</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Flag high-complexity depositions; allocate senior reporters; predict timeline/cost.</p>
