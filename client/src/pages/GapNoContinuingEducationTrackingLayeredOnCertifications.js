...
/**
 * Gap/CFS Feature Page: No continuing-education tracking layered on `certifications`.
 * Slug: no-continuing-education-tracking-layered-on-certifications
 * Backend: /api/gap-no-continuing-education-tracking-layered-on-certifications
 */
export default function NoContinuingEducationTrackingLayeredOnCertificationsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-continuing-education-tracking-layered-on-certifications', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No continuing-education tracking layered on `certifications`.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No continuing-education tracking layered on `certifications`.</p>
