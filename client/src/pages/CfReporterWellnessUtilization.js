...
/**
 * Gap/CFS Feature Page: Reporter wellness & utilization
 * Slug: reporter-wellness-utilization
 * Backend: /api/cf-reporter-wellness-utilization
 */
export default function ReporterWellnessUtilizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-reporter-wellness-utilization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Reporter wellness & utilization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Predict reporter burnout; suggest rotation to balance high-stress cases.</p>
